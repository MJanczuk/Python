...
# make data
import AdapterIO
Dane = AdapterIO.IEN_v1('Grid_Startup.rec')
N = 2
A = 0
F = 1
P = 4
...
axs[0].step([-20,-10,0,35.4,37.06,56.5,150], [60,60,70,69,68,67,67], label='Setpoint [%]', color='black',where='post')
...
#axs[2].plot(X[K], Y[K], label='Sequence step', color='violet')
